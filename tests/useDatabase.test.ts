  ...
  describe('Voice Recordings', () => {
    ...
    it('should get user voice recordings', async () => {
      ...
      const mockRecordings = [
        { id: 'rec-1', surah_number: 1, verse_number: 1, duration: 5.0 },
        { id: 'rec-2', surah_number: 1, verse_number: 2, duration: 6.0 },
      ];
    ...
    it('should delete voice recording', async () => {
      ...
      expect(mockInvoke).toHaveBeenCalledWith('db_delete_voice_recording', {
