...
import { Home, BookOpen, Heart, Settings, Bell, Wand2 } from "lucide-react";
...
const navItems = [
    ...
    { path: "/wird", icon: Wand2, label: "My Wird" },
                ...
                <div className="p-6 pb-4">
                    <div className="flex items-center gap-3">
                        <div
                            ...
                            style={{
                                background:
                                    "linear-gradient(135deg, #6a2428, #4a1518)",
                        ...
                        return (
                            <NavLink key={path} to={path}>
                                <motion.div
                                    ...
                                    style={{
                                        background: active
                                            ? "rgba(220,160,72,0.15)"
                                            : "transparent",
                                        border: active
                                            ? "1px solid rgba(220,160,72,0.25)"
