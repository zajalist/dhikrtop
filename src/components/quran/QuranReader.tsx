        ...
        <div className="min-h-full p-4 md:p-6 max-w-3xl mx-auto">
            ...
            >
                ...
                <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                        {[
                            ...
                            <GlowCard
                                key={surah.name}
                                className="p-4 cursor-not-allowed opacity-60"
                            >
                                <div
                ...
                <GlowCard className="p-6">
                    ...
                    >
                        Tajweed is the science of Quranic recitation. When the
                        reader fully masters the rules of tajweed, the Quran
                        sounds beautiful and is recited correctly.
                    </p>
