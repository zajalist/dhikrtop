    ...
    return (
        <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
            ...
            <div
                ...
                style={{
                    background:
                        "radial-gradient(ellipse at 20% 20%, #1a0508 0%, #0d0205 50%, #080105 100%)",
                }}
            />
    ...
    return (
        <div
            ...
            style={{
                ...
                border: gold
                    ? "1px solid rgba(220,160,72,0.4)"
                    : "1px solid rgba(220,160,72,0.15)",
                boxShadow: gold
