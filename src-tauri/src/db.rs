...
impl Database {
    ...
    pub async fn save_adhkar_progress(&self, progress: &AdhkarProgress) -> Result<AdhkarProgress, DbError> {
        let now = Self::now();
    ...
    pub async fn get_adhkar(&self, user_id: &str, adhkar_id: &str) -> Result<Option<AdhkarProgress>, DbError> {
        sqlx::query_as::<_, AdhkarProgress>(
    ...
    pub async fn save_quran_progress(&self, progress: &QuranProgress) -> Result<QuranProgress, DbError> {
        let now = Self::now();
    ...
    pub async fn get_surah_progress(&self, user_id: &str, surah_number: i32) -> Result<Vec<QuranProgress>, DbError> {
        sqlx::query_as::<_, QuranProgress>(
    ...
    pub async fn save_voice_recording(&self, recording: &VoiceRecording) -> Result<VoiceRecording, DbError> {
    ...
    pub async fn get_voice_recordings(&self, user_id: &str) -> Result<Vec<VoiceRecording>, DbError> {
        sqlx::query_as::<_, VoiceRecording>(
    ...
    pub async fn get_verse_recordings(&self, user_id: &str, surah_number: i32, verse_number: i32) -> Result<Vec<VoiceRecording>, DbError> {
        sqlx::query_as::<_, VoiceRecording>(
