...
export const surahs: Surah[] = [
  {
    ...
    verses: [
      ...
      },
      {
        ...
        tajweed: [
          { text: 'إِيَّاكَ ', rule: 'madd' },
          { text: 'نَعْبُدُ ', rule: null },
          { text: 'وَإِيَّاكَ ', rule: 'madd' },
      ...
      },
      {
        ...
        tajweed: [
          { text: 'اهْدِنَا ', rule: null },
          { text: 'الصِّرَاطَ ', rule: 'madd' },
      ...
      },
      {
        ...
        tajweed: [
          ...
          { text: 'الَّذِينَ ', rule: 'madd' },
          { text: 'أَنْعَمْتَ ', rule: 'ghunna' },
          { text: 'عَلَيْهِمْ ', rule: null },
          { text: 'غَيْرِ ', rule: null },
          { text: 'الْمَغْضُوبِ ', rule: null },
          { text: 'عَلَيْهِمْ ', rule: null },
          { text: 'وَلَا ', rule: 'madd' },
          { text: 'الضَّالِّينَ', rule: 'madd' },
        ],
      },
    ],
  },
  {
    ...
    name: 'Al-Ikhlas',
    arabicName: 'الإخلاص',
    englishMeaning: 'Sincerity / Purity of Faith',
    totalVerses: 4,
    revelationType: 'Meccan',
    verses: [
      {
